...
static unsigned char const Font0[95][16] = {
...
static unsigned char const Font1[95][16] = {
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*" ",0*/
...
{0x00,0x00,0x00,0x1E,0x33,0x33,0x33,0x37,0x3B,0x33,0x33,0x1E,0x00,0x00,0x00,0x00},/*"0",16*/
...
//#endif
//Courier??? - szeryfowa 
static unsigned char const Font2[95][16] = {
...
*******************************************************************************/
/*
void _GetASCIICode(unsigned char* pBuffer,unsigned char ASCII)
{  
...
const unsigned char * GetASCIIptr(unsigned char ASCII)
{
	//can be switchable
	if(font==0)
		return (const unsigned char *)(Font0 + (ASCII - 32));
	if(font==1)
		return (const unsigned char *)(Font1 + (ASCII - 32));
	else
		return (const unsigned char *)(Font2 + (ASCII - 32));
}
/*********************************************************************************************************
      END FILE
*********************************************************************************************************/
